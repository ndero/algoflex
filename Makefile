.PHONY: sync setup test lint format format-check build build-offline check run lock clean help
...
help:
	...
	@echo "\n    make check\n      - check for linting errors, formatting issues and build errors"