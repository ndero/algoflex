fn main() {
    let test_cases = vec![
        ...
        ((vec![2],), 2),
        ((vec![134, 140, 147, 156, 160, 164, 166, 166, 170, 183, 184, 192, -9, -4, 1, 20, 51, 54, 54, 56, 67, 75, 80, 88, 92, 93, 96, 105, 115, 127],), -9),
        // Edge cases
    ...
    std::process::exit(
        run_tests!(&test_cases, |input| min_rotated_arr(&input.0))
    );
}