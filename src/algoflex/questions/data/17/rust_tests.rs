fn main() {
    let test_cases = vec![
        ...
        (
            (
                5,
                vec![10, 20, 30].repeat(1000),
                vec![60, 100, 120].repeat(1000),
            ),
            30.0,
        ),
        (
            (
                5000,
                vec![10, 20, 30].repeat(100_000),
                vec![60, 100, 120].repeat(100_000),
            ),
            30_000.0,
        ),
        // Edge cases
    ...
    std::process::exit(run_tests!(&test_cases, |input| fractional_knapsack(
